...
expect.extend((0, _lodash.reduce)(_supportedMatchers.default, function (result, matcherName, methodName) {
  ...
  return (0, _objectSpread3.default)({}, result, (_objectSpread2 = {}, (0, _defineProperty2.default)(_objectSpread2, matcherName, createToHaveBeenCalledMatcher(".".concat(matcherName), methodName)), (0, _defineProperty2.default)(_objectSpread2, matcherNameWith, createToHaveBeenCalledWith(".".concat(matcherNameWith), methodName)), _objectSpread2));
}, {}));
